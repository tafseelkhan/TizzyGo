...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.container}>
      {/* Gradient Background - Using View with opacity instead of LinearGradient */}
        ...
        {!isKeyboardVisible && (
          <>
            <View style={styles.lottieWrapper}>
              <LottieView
                ref={lottieRef}
                source={require('../../../core/components/animations/lotties/Teacher girl woman tapping phone (1).json')}
              ...
              <View style={styles.lottieOverlay}>
                <Text style={styles.lottieTitle}>Welcome Back!</Text>
                <Text style={styles.lottieDescription}>
      ...
      >
        ...
        <View style={styles.glassTabsContainer}>
          ...
          >
            ...
            />
            <Text style={styles.glassTabText}>SignUp</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.glassTab, styles.glassTabActive]}>
            <Icon
              name="log-in"
              size={20}
              color="#ffffff"
              style={styles.tabIcon}
            />
            <Text style={styles.glassTabTextActive}>LogIn</Text>
          </TouchableOpacity>
        </View>
